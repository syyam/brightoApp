...
public class ProductFilterAdapter extends RecyclerView.Adapter<ProductFilterAdapter.CF_ViewHolder> {

    private ProductFilter context;
    private List<ProductsDatum> colors;

    public ProductFilterAdapter(ProductFilter context, List<ProductsDatum> colors) {
